			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item">
							<a href="<?= base_url(); ?>perwira/<?= $method; ?>"><?= $header; ?></a>
						</li>
			...
			<div class="row">
				<div class="card card-default col-sm-12" style="text-align:center;">
					<div class="card-body col-sm-12">
						...
						<h3>Jenis Kenaikan Pangkat (<span style="color: #673AB7; font-weight: bold;"><?= $ketjeniskp; ?></span><span style="color: #D32F2F; font-weight: bold;"> MDP : <?= $mdp; ?> th dan MDDP : <?= $mddp; ?> th</span>)</h3><br />
						<h4>TMT Perwira Anda = <strong><?= $tmtperwira; ?><span style="color: #D32F2F;"><?= " (" . $ketmdp . " " . $mdp . " th) "; ?></span></strong></h4>
